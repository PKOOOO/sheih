...
export const INITIAL_SUBJECTS = [
  ...
  { id: "sub-fqh", name: "Islamic Jurisprudence (Fiqh)", code: "FQH", category: "Islamic Law", description: "Principles of Islamic law and worship", levels: ["junior", "senior"] },
  ...
  { id: "sub-hdt", name: "Hadith Studies", code: "HDT", category: "Islamic Sciences", description: "Prophetic traditions and their sciences", levels: ["senior"] },
  { id: "sub-aqd", name: "Aqeedah (Creed)", code: "AQD", category: "Islamic Sciences", description: "Islamic theology and belief", levels: ["junior", "senior"] },
  { id: "sub-ihc", name: "Islamic History & Civilization", code: "IHC", category: "History", description: "History of Islam and Muslim civilization", levels: ["senior"] },
];
